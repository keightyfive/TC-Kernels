...
SAC_ND_DEF_FUN_BEGIN2( SACf__MAIN__main, void,  SAC_ND_PARAM_out( (SAC_arg_1, (SCL, (NHD, (NUQ, (INT, (GLO, (FPM, (NOT, (NDI, (INT, )))))))))), int))
{
  ...
  { 
    ...
    SAC_ND_DECL_CONST__DATA((SACp_emal_6476__flat_439, (SCL, (NHD, (NUQ, (INT, (GLO, (NON, (NOT, (NDI, (INT, )))))))))), int, 4)
    /*
    ...
    SAC_ND_DEC_RC_FREE((SACp_emal_6476__flat_439, (SCL, (NHD, (NUQ, (INT, (GLO, (NON, (NOT, (NDI, (INT, )))))))))), 1, )
    /*
...
int main( int __argc, char *__argv[])
{
  ...
  SAC_RTSPEC_SETUP_INITIAL(2, " -o gconv3 gconv3.sac");
  SAC_PF_SETUP();
  SAC_HM_SETUP();
  SAC_MT_SETUP();
  SAC_CS_SETUP();
